  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-5 text-center">
      ...
      <p className="mt-3 max-w-[44ch] text-muted">
        We couldn't load this page. Please try again or come back later.
      </p>

      {process.env.NODE_ENV === "development" && (
        <p className="mt-3 max-w-[60ch] rounded-xl border border-border bg-surface px-4 py-2 text-left font-mono text-xs text-red-400">
          {error.message}
        </p>
      )}
